              ...
              {items.length > 0 ? (
                items.map((item, idx) => {
                  ...
                  return (
                    <tr key={idx} style={{ background: idx % 2 === 0 ? "#ffffff" : "#f8fafc", borderBottom: "1px solid #e2e8f0" }}>
                      ...
                      <td style={{ padding: "10px 14px", textAlign: "center" }}>{qty}</td>
                      <td style={{ padding: "10px 14px", textAlign: "right" }}>₹{rate.toLocaleString("en-IN", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
                      <td style={{ padding: "10px 14px", textAlign: "right", fontWeight: "700" }}>₹{total.toLocaleString("en-IN", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
                    </tr>
                  );
                })
              ) : (
                <tr>
                  <td colSpan={5} style={{ padding: "20px", textAlign: "center", color: "#94a3b8" }}>
                    1x Store Retail Sale Transaction (₹{totalVal.toFixed(2)})
                  </td>
                </tr>
              )}
            </tbody>
